...
\begin{document}
	...
	In this scheme, the nondimensionalized elastic free energy is given by:
	\begin{equation}
		f_e = \partial_k Q_{ij} \partial_k Q_{ij} 
		+ \kappa_2 \partial_j Q_{ij} \partial_k Q_{ik} 
		+ \kappa_3 Q_{kl} \partial_k Q_{ij} \partial_l Q_{ij}
	\end{equation}
